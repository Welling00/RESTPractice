...
import com.psl7504.app.ws.exceptions.MissingRequiredFieldException;
...
public class UserProfileUtils {
    ...
    public String gererateUUID() {
        String returnValue = UUID.randomUUID().toString().replaceAll("-", "");
        return returnValue;
    }
    // Generates Randome AlphaNumeric UserID from ALPHABET 
    //defined above at a defined length.
